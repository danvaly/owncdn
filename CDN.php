...
class CDN
{
    ...
    public static function serve($origin = null, $cache_path = null, $fix_request = null, $cache_expire = 2628000){
        return new self($origin, $cache_path, $fix_request, $cache_expire);
    }
    ...
    private function setup($accepted = array())
    {
        ...
        $this->cache_dir = substr($this->cache_name,0,2).DIRECTORY_SEPARATOR.substr($this->cache_name,2,2).DIRECTORY_SEPARATOR.substr($this->cache_name,4,2).DIRECTORY_SEPARATOR;
        if (!is_dir($this->cache_path.$this->cache_dir)){
            @mkdir($this->cache_path.$this->cache_dir, 0777, true);
        }
        // set final working cache_path
        $this->cache_full = $this->cache_path.$this->cache_dir.$this->cache_name.'.'.$this->request_info['extension'];
    }
